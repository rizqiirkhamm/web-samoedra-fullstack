    ...
    <section id="home" class="relative z-0">
        <div
            ...
            <div class="flex items-center w-full md:w-1/2">
                <div class="flex-col">
                    <h1 class="text-[#3E5467] font-semibold text-2xl sm:text-4xl xl:text-5xl"
                        style="font-family: 'Fredoka';">Halo👋🏻,
                        Selamat Datang
                    </h1>
                    <div class="flex items-center gap-2">
                        <h1 class="text-[#3E5467] font-semibold text-2xl sm:text-4xl xl:text-5xl leading-none"
                            style="font-family: 'Fredoka';">
                            Di Rumah</h1>
                        <img src="images/assets/text_samoedra.png" class="sm:h-12 h-9 xl:h-18" alt="">
                    </div>
                    <p id="des-home" class=" text-[#A2A2BD] max-w-xl mt-4">
                        {{ $homeContent->description ?? 'Rumah Samoedra adalah ruang bermain dan belajar anak dengan layanan daycare, area bermain, bimbel, kelas stimulasi, serta event seperti playdate, ulang tahun, dan outing class.' }}
                    </p>
                    <div class="flex gap-5 mt-6">
                        ...
                        <a href="{{ $homeContent->phone_link ?? '#' }}" class="flex space-x-2 items-center">
                            <svg width="28" height="28" viewBox="0 0 32 33" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <mask id="mask0_68_61" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0"
                            ...
                            <h1 class="text-[#A2A2BD]">{{ $homeContent->phone_number ?? '+62 896 111 111 53' }}</h1>
                        </a>
                    </div>
                </div>
            </div>
            <div class="w-full md:w-1/2 relative flex justify-center items-center mb-16 md:mb-0">
                <div class="w-full md:max-w-[600px] md:h-[600px] p-3 xl:p-6 bg-[#91CFE0] mask-home relative z-10">
                    <div class="mask-home h-full">
                        <img id="img-home"
                            src="{{ asset('storage/' . ($homeContent->image ?? 'images/assets/img.png')) }}"
        ...
        <div class="relative mt-28">
            ...
            <div class="w-full relative flex flex-col justify-center items-center py-28">
                ...
                <h1 class="text-[#3E5467] text-3xl md:text-4xl font-semibold" style="font-family: 'Fredoka';">Program
                    Layanan Kami</h1>
                <img src="images/assets/ikan_biru.svg" alt="Ikan Biru"
                    class="w-32 absolute right-15 top-30 hidden md:flex scale-x-[-1]">
                <img src="images/assets/bintang_laut_pink.svg" alt="Bintang"
                    class="w-24 absolute left-10 bottom-40 hidden md:flex">
                <img src="images/assets/bintang_laut_kuning.svg" alt="Bintang"
                    class="w-14 absolute left-27 bottom-25 hidden md:flex">
                    ...
                    <div class="flex flex-row gap-7 py-10 overflow-x-auto scroll-smooth" id="cards-container">
                        ...
                        <div class="card-item w-80 h-96 rounded-4xl bg-white p-6 flex flex-col relative">
                            @if($bermainData && $bermainData['banner_image'])
                                <img src="{{ asset('storage/' . $bermainData['banner_image']) }}" alt="Area Main"
                                    class="w-full h-44 rounded-3xl object-cover">
                            @else
                                <img src="{{ asset('images/assets/img_layanan.png') }}" alt="Area Main"
                                    class="w-full h-44 rounded-3xl object-cover">
                            @endif
                            <div class="flex justify-between my-5">
                                <h1 class="text-3xl text-[#3E5467] font-semibold" style="font-family: 'Fredoka';">Area
                                    Main</h1>
                                <div class="px-3 py-1 rounded-xl bg-[#7BA5B0] flex items-center">
                                    <p class="text-white" style="font-family: 'Onest';">{{ $bermainData['about_bermain']['details']['jam_operasional'] ?? '08.00 - 15.00' }}</p>
                                </div>
                            </div>
                            <p class="text-[#A2A2BD] flex-grow">
                                @if($bermainData && $bermainData['benefit_description'])
                                    {{ \Str::limit($bermainData['benefit_description'], 100, '...') }}
                                @else
                                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Hic assumenda ut illo.
                                @endif
                            </p>
                        ...
                        <div class="card-item w-80 h-96 rounded-4xl bg-white p-6 flex flex-col relative">
                            ...
                            <div class="flex justify-between my-5">
                                ...
                                <div class="px-3 py-1 rounded-xl bg-[#7BA5B0] flex items-center">
                                    <p class="text-white" style="font-family: 'Onest';">{{ $bimbelData['about_bimbel']['details']['jam_operasional'] ?? '08.00 - 15.00' }}</p>
                                </div>
                            </div>
                            <p class="text-[#A2A2BD] flex-grow">
                                @if($bimbelData && $bimbelData['benefit_description'])
                                    {{ \Str::limit($bimbelData['benefit_description'], 100, '...') }}
                                @else
                                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Hic assumenda ut illo.
                                @endif
                            </p>
                        ...
                        <div class="card-item w-80 h-96 rounded-4xl bg-white p-6 flex flex-col relative">
                            ...
                            <p class="text-[#A2A2BD] flex-grow">
                                @if($stimulasiData && $stimulasiData['description'])
                                    {{ \Str::limit($stimulasiData['description'], 100, '...') }}
                                @else
                                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Hic assumenda ut illo.
                                @endif
                            </p>
                        ...
                        <div class="card-item w-80 h-96 rounded-4xl bg-white p-6 flex flex-col relative">
                            @if($eventData && isset($eventData['events']) && count($eventData['events']) > 0)
                                ...
                                @if($latestEvent['banner_type'] == 'video')
                                    <div class="w-full h-44 rounded-3xl overflow-hidden">
                                        <iframe width="100%" height="100%" src="https://www.youtube.com/embed/{{ $latestEvent['banner_video'] }}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
                                @else
                                    @if($latestEvent && $latestEvent['banner_image'])
                                        <img src="{{ asset($latestEvent['banner_image']) }}" alt="Event"
                                            class="w-full h-44 rounded-3xl object-cover">
                                    @else
                                ...
                                <div class="flex justify-between my-5">
                                    ...
                                    <div class="px-3 py-1 rounded-xl bg-[#7BA5B0] flex items-center">
                                        <p class="text-white" style="font-family: 'Onest';">{{ $latestEvent['about_event']['tanggal'] ?? '08.00 - 15.00' }}</p>
                                    </div>
                                </div>
                                <p class="text-[#A2A2BD] flex-grow">
                                    @if(isset($latestEvent['descriptions'][0]['content']))
                                        {{ \Str::limit($latestEvent['descriptions'][0]['content'], 100, '...') }}
                                    @else
                                        Berbagai event menarik seperti playdate, ulang tahun, dan outing class yang dapat memberikan pengalaman bermain dan belajar yang menyenangkan untuk anak-anak.
                                    @endif
                                </p>
                            @else
                                <img src="{{ asset('images/assets/img_layanan.png') }}" alt="Event"
            ...
            <div class="relative w-full  px-8 ">
                ...
                <div class="relative min-h-[1000px] md:min-h-0 ">
                    ...
                    <div class="absolute left-5 sm:left-20 bottom-10 sm:bottom-20 z-20">
                        <img src="images/assets/ubur2.svg" alt="Ubur-Ubur"
                            class="w-24 h-24 sm:w-32 sm:h-32 animate-float">
                    </div>
                    ...
                    <div class="absolute left-10 sm:left-40 top-0 sm:-top-10 z-20">
                        <img src="images/assets/kura2.svg" alt="Kura-Kura"
                            class="w-24 h-24 sm:w-42 sm:h-42 animate-swim">
                    </div>
                    ...
                    <!-- Konten Utama -->
                    <div class="absolute top-0 left-0 w-full  flex h-full items-center justify-center p-4 z-50">
        ...
        <div class="w-full px-8 md:w-3/4 md:px-0 mx-auto">
            ...
            <div class="mt-10 overflow-x-auto flex space-x-6 no-scrollbar">
                ...
                <div class="w-96 flex-shrink-0">
                    <div
                        class="border-2 border-orange-300 border-dashed rounded-4xl p-7 flex flex-col testimoni-card min-h-[230px]">
                        <div class="flex items-center space-x-4">
                            <div class="relative">
                                @if($testimoni->foto)
                                <img src="{{ asset($testimoni->foto) }}" alt="{{ $testimoni->nama }}"
                                ...
                                <span
                                    ...
                                    <span
                                        class="bg-orange-300 text-white text-lg font-bold rounded-full w-5 h-5 items-center justify-center flex text-center">
                                        <img class="w-[10px]" src="images/assets/" .svg" alt="">
                                    </span>
                                </span>
                            </div>
                            <h3 class="text-2xl font-semibold text-[#3E5467]" style="font-family: 'Fredoka';">
                                {{ $testimoni->nama }}</h3>
                        </div>
                        <div class="mt-5 flex-grow">
                            <div class="testimoni-content">
                                <p class="text-[#A2A2BD] line-clamp-4 testimoni-text">
                                    {{ $testimoni->testimoni }}
                                </p>
                            </div>
        ...
        <div class="w-full px-8 md:w-3/4 md:px-0 mx-auto py-20">
            <div class="text-center">
                ...
                <h1 class="text-[#3E5467] text-3xl md:text-4xl font-semibold" style="font-family: 'Fredoka';">Pertanyaan
                    Sering
                    Ditanyakan</h1>
            </div>
                    ...
                    <div class="w-full max-w-[500px] h-[500px] mx-auto p-3 xl:p-5 bg-[#91CFE0] mask-faq relative z-10">
                        <div class="mask-faq h-full">
                            <img src="{{ asset('images/faq/faq.png') }}"
                                class="w-full h-full object-cover object-center" alt="FAQ Image"
                ...
                <div class="mt-6 space-y-6 w-full md:w-1/2">
                    ...
                    <div class="faq-item bg-[#EFF5F6] px-6 py-4 rounded-2xl cursor-pointer transition-all duration-300"
                        ...
                        <div class="flex justify-between items-center">
                            <span class="font-semibold text-[#3E5467] text-2xl"
                                style="font-family: 'Fredoka';">{{ $faq->pertanyaan }}</span>
                            <div class="w-7 h-7 aspect-square flex items-center justify-center rounded-full bg-[#E8A26A] transition-transform duration-300"
                                id="icon-{{ $index + 1 }}">
                                <svg width="16" height="10" viewBox="0 0 21 12" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M19.0957 2L10.6016 10L2.10751 2" stroke="#F3EEE6" stroke-width="3"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </div>
                        </div>
                    ...
                    <div class="border-t-[0.5px] w-full h-32 mt-3 border-slate-200">
                        ...
                        <a href="{{ route('faq.public') }}">
                            <p class="text-[#E8A26A] font-bold pt-4">Lihat Lainnya</p>
                        </a>
                    </div>
                </div>
            </div>
