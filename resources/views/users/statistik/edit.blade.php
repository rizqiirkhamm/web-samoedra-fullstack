...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-[#3E5467]">Edit Statistik {{ ucfirst($kategori) }}</h1>
        </div>
            ...
            <form action="{{ route('statistik.update', $kategori) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="judul" id="judul" value="{{ $statistik->{$kategori.'_title'} }}"
                        class="w-full bg-gray-50 dark:bg-darkblack-500 border-2 border-gray-200 dark:border-darkblack-400 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-green-300 focus:border-transparent transition-all duration-300"
                        required>
                    @error('judul')
