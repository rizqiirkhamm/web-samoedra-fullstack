<aside
    ...
    <div
        ...
        <div class="nav-wrapper mb-[36px] pr-[50px]">
            ...
            <!-- Konten -->
            @if(!empty($PermissionEvent) || !empty($PermissionJournal) || !empty($PermissionArticle) || !empty($PermissionGallery) || !empty($PermissionFaq) || !empty($PermissionTestimoni) || !empty($PermissionStatistik))
            <div class="item-wrapper mb-5">
                <h4 class="border-b border-bgray-200 text-sm font-medium leading-7 text-bgray-700 dark:border-darkblack-400 dark:text-bgray-50">
                    Konten
                </h4>
            ...
            <!-- Pengaturan Frontend -->
            @if(!empty($PermissionTentang) || !empty($PermissionDaycareEdit) || !empty($PermissionBermainEdit) || !empty($PermissionBimbelEdit) || !empty($PermissionStimulasiEdit) || !empty($PermissionEventEdit) || !empty($PermissionHomeContent))
            <div class="item-wrapper mb-5">
                <h4 class="border-b border-bgray-200 text-sm font-medium leading-7 text-bgray-700 dark:border-darkblack-400 dark:text-bgray-50">
                    Pengaturan Frontend
                </h4>
                <ul class="mt-2.5">
                    ...
                    <li class="item py-[11px] text-bgray-900 dark:text-white">
                        <a href="{{ route('home-content.index') }}" class="flex items-center justify-between {{ Request::is('home-content*') ? 'active' : '' }}">
                            <div class="flex items-center space-x-2.5">
                                <span class="item-ico">
