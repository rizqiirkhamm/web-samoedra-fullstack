                    ...
                    <form action="{{ route('update.bermain') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="benefit_title" name="benefit_title" value="{{ $bermain['benefit_title'] ?? 'Kelebihan Area Bermain Kami' }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-darkblack-500 dark:border-darkblack-400 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="info_title" name="info_title" value="{{ $bermain['info_title'] ?? 'About Area Bermain' }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-darkblack-500 dark:border-darkblack-400 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </div>

                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="mb-4">
                                    <label for="age_range" class="block mb-2 text-sm font-medium text-gray-900 dark:text-bgray-50">Rentang Usia</label>
                                    <input type="text" id="age_range" name="age_range" value="{{ $bermain['age_range'] ?? '6 bln - 12 y.o' }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-darkblack-500 dark:border-darkblack-400 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                </div>

                                <div class="mb-4">
                                    <label for="operating_hours" class="block mb-2 text-sm font-medium text-gray-900 dark:text-bgray-50">Jam Operasional</label>
                                    <input type="text" id="operating_hours" name="operating_hours" value="{{ $bermain['operating_hours'] ?? '9:00 - 17:00' }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-darkblack-500 dark:border-darkblack-400 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                </div>

                                <div class="mb-4">
                                    <label for="operating_days" class="block mb-2 text-sm font-medium text-gray-900 dark:text-bgray-50">Hari Operasional</label>
                                    <input type="text" id="operating_days" name="operating_days" value="{{ $bermain['operating_days'] ?? 'Senin-Sabtu' }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-darkblack-500 dark:border-darkblack-400 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                </div>
...
(max 6jam)' }}</textarea>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="mb-4">
                                <label for="facility_title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-bgray-50">Judul Fasilitas</label>
                                <input type="text" id="facility_title" name="facility_title" value="{{ $bermain['facility_title'] ?? 'Area Bermain' }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-darkblack-500 dark:border-darkblack-400 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </div>

                            <div id="facilities-container">
                                @if(isset($bermain) && isset($bermain['facilities']))
                                    @foreach($bermain['facilities'] as $index => $facility)
                                        <div class="facility-item border rounded-lg p-4 mb-4 dark:border-darkblack-400">
                                            <div class="flex justify-between items-center mb-2">
                                                <h4 class="font-semibold dark:text-white">Fasilitas {{ $index + 1 }}</h4>
                                                <button type="button" class="remove-facility text-red-600 hover:text-red-800 dark:text-red-500 dark:hover:text-red-400">Hapus</button>
                                            </div>
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                <div>
                                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-bgray-50">Nama Fasilitas</label>
                                                    <input type="text" name="facility_name[]" value="{{ $facility['name'] }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-darkblack-500 dark:border-darkblack-400 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                </div>
                                                <div>
                                                    ...
                                                    @endif
                                                    <input type="file" name="facility_image[]" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-bgray-300 focus:outline-none dark:bg-darkblack-500 dark:border-darkblack-400">
                                ...
                                @else
                                    <div class="facility-item border rounded-lg p-4 mb-4 dark:border-darkblack-400">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div>
                                                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-bgray-50">Nama Fasilitas</label>
                                                <input type="text" name="facility_name[]" value="Full AC" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-darkblack-500 dark:border-darkblack-400 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                            </div>
                                            <div>
                                                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-bgray-50">Gambar Fasilitas</label>
                                                <input type="file" name="facility_image[]" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-bgray-300 focus:outline-none dark:bg-darkblack-500 dark:border-darkblack-400">
                            ...
                            <button type="button" id="add-facility" class="px-4 py-2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm text-white dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Tambah Fasilitas</button>
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="mb-8">
                                <p class="mb-4 text-sm text-gray-500 dark:text-bgray-300">Untuk mengelola galeri, silakan menggunakan halaman <a href="{{ route('gallery.index') }}" class="text-blue-600 hover:underline dark:text-blue-400">manajemen galeri</a> dan pilih kategori "Area Main".</p>
                            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        addFacilityBtn.addEventListener('click', function() {
            ...
            newFacility.className = 'facility-item border rounded-lg p-4 mb-4 dark:border-darkblack-400';
            newFacility.innerHTML = `
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-bgray-50">Nama Fasilitas</label>
                        <input type="text" name="facility_name[]" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-darkblack-500 dark:border-darkblack-400 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-bgray-50">Gambar Fasilitas</label>
                        <input type="file" name="facility_image[]" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-bgray-300 focus:outline-none dark:bg-darkblack-500 dark:border-darkblack-400">
