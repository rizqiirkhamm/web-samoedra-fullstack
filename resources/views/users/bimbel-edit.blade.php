    ...
    <form action="{{ route('bimbel.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <!-- Banner Utama Section -->
                            ...
                            <div class="mb-4">
                                ...
                                <div class="flex space-x-4">
                                    <div class="flex items-center">
                                        <input type="radio" name="banner_type" id="banner_type_image" value="image" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" {{ $bimbel['banner_type'] == 'image' ? 'checked' : '' }}>
                                        <label for="banner_type_image" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Gambar</label>
                            </div>
                                    <div class="flex items-center">
                                        <input type="radio" name="banner_type" id="banner_type_video" value="video" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" {{ $bimbel['banner_type'] == 'video' ? 'checked' : '' }}>
                                        <label for="banner_type_video" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Video YouTube</label>
                            </div>
                        </div>
                    </div>

                            <div id="banner_image_container" class="mb-4 {{ $bimbel['banner_type'] == 'image' ? '' : 'hidden' }}">
                        ...
                        @endif
                            ...
                            <div id="banner_video_container" class="mb-4 {{ $bimbel['banner_type'] == 'video' ? '' : 'hidden' }}">
        ...
        <!-- Benefit Section -->
                        <div class="mb-8">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="benefit_title" id="benefit_title" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ $bimbel['benefit_title'] ?? '' }}">
                    </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="benefit_description" id="benefit_description" rows="4" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{ $bimbel['benefit_description'] ?? '' }}</textarea>
            </div>
        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="age_range" id="age_range" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ $bimbel['age_range'] ?? '' }}">
                    </div>

                                <div class="mb-4">
                                    <label for="operating_hours" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jam Operasional</label>
                                    <input type="text" name="operating_hours" id="operating_hours" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ $bimbel['operating_hours'] ?? '' }}">
                    </div>
                    </div>

                            <div class="mb-4">
                                <label for="operating_days" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Hari Operasional</label>
                                <input type="text" name="operating_days" id="operating_days" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ $bimbel['operating_days'] ?? '' }}">
                    </div>
                            ...
                            @endif
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <img src="{{ asset($bimbel['program_image']) }}" alt="Program Preview" class="image-preview mb-2">
                                            @endif
                                            <div class="flex-1">
                ...
                @if(isset($bimbel['facilities']))
                    ...
                    <div class="facility-item border rounded-lg p-4 mb-4">
                        ...
                        <div class="mt-4">
                            ...
                            @endif
                            <input type="file" name="facility_items[{{ $index }}][image]" class="facility-image-input block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" accept="image/*" onchange="previewImage(this)">
                    ...
                    <div id="pricing_items_container">
                        @if(isset($bimbel['pricing_items']))
                            ...
                            <div class="pricing-item border rounded-lg p-4 mb-4">
                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Layanan/Bimbel</label>
                                    <input type="text" name="pricing_items[{{ $index }}][service]" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ $item['service'] }}" required>
                                    </div>

                                    <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jenjang Tersedia</label>
                                    <input type="text" name="pricing_items[{{ $index }}][levels]" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ $item['levels'] }}" required>
                                    </div>

                                    <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Promo Pendaftaran*</label>
                                    <input type="text" name="pricing_items[{{ $index }}][registration_promo]" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ $item['registration_promo'] }}" required>
                                    </div>

                                    <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tarif / Pertemuan</label>
                                    <input type="number" name="pricing_items[{{ $index }}][price_per_session]" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ $item['price_per_session'] }}" required>
                                    </div>

                                    <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tarif / Pertemuan Promo 25%**</label>
                                ...
                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tarif Bulanan</label>
                                    <input type="number" name="pricing_items[{{ $index }}][monthly_price]" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ $item['monthly_price'] }}" required>
                                        </div>

                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tarif Bulanan Promo**</label>
                                    <input type="number" name="pricing_items[{{ $index }}][monthly_price_promo]" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ $item['monthly_price_promo'] }}" required>
                                    </div>

                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jumlah Pertemuan/Sebulan</label>
                                    <input type="number" name="pricing_items[{{ $index }}][sessions_per_month]" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ $item['sessions_per_month'] }}" required>
                                </div>

                                <button type="button" class="remove-pricing text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2 dark:bg-red-600 dark:hover:bg-red-700 focus:outline-none dark:focus:ring-red-800">
                                    Hapus Paket
                                </button>
                                </div>
                            @endforeach
            ...
            addFacilityBtn.addEventListener('click', function() {
                ...
                newItem.innerHTML = `
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Deskripsi</label>
                            <input type="text" name="facility_items[${facilityCounter}][description]" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                        </div>
                    </div>
                    <div class="mt-4">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Gambar Fasilitas</label>
                        <input type="file" name="facility_items[${facilityCounter}][image]" class="facility-image-input block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" accept="image/*" onchange="previewImage(this)">
                        <div class="mt-2 hidden preview-container">
                            <img class="preview-image max-w-xs h-auto rounded-lg shadow-xl dark:shadow-gray-800" src="" alt="Preview">
                        </div>
                    </div>
