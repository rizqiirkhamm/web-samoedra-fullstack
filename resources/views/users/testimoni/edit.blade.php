            ...
            <div class="mb-4">
                ...
                <div class="flex items-center space-x-6">
                    <div class="w-24 h-24 rounded-full overflow-hidden bg-gray-100 dark:bg-darkblack-500 flex items-center justify-center border-2 border-dashed border-gray-300 dark:border-darkblack-400">
                        <img id="preview" src="{{ asset($testimoni->foto ?? 'images/assets/iky.png') }}" alt="Preview" class="w-full h-full object-cover {{ !$testimoni->foto ? 'hidden' : '' }}">
                        <svg id="default-icon" class="w-12 h-12 text-gray-400 {{ $testimoni->foto ? 'hidden' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
