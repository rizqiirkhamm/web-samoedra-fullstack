<footer class="relative bg-[#EFF5F6] md:bg-none mt-28">
    ...
    <div class="w-full px-8 md:px-0 md:w-3/4 mx-auto grid grid-cols-1 md:grid-cols-3 md:gap-8 py-5">
        ...
        <div class="text-left">
            ...
            <div class="flex space-x-3 mt-6 relative z-30">
                <a href="https://www.instagram.com/maindisamoedra/">
                    <div
                ...
                <a href=" https://www.facebook.com/maindisamoedra?mibextid=wwXIfr&rdid=b5KMGDWw6GL6TYmw&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F18Ue9W7tfF%2F%3Fmibextid%3DwwXIfr#">
                    <div
                ...
                <a href="https://wa.me/6289611111153">
                    <div
                    class="w-9 h-9 p-2 aspect-square bg-[#3E5467] hover:bg-[#BDBDCB] transition-all rounded-xl flex justify-center items-center">
                ...
                <a href="https://www.tiktok.com/@maindisamoedra?_t=ZS-8vY11XStCTs&_r=1">
                    <div
                    class="w-9 h-9 p-2.5 aspect-square bg-[#3E5467] hover:bg-[#BDBDCB] transition-all rounded-xl flex justify-center items-center">
        ...
        <div class="flex flex-col space-y-6 mt-8 md:mt-0 z-30">
            <!-- Alamat -->
            <div>
                <a href="https://maps.app.goo.gl/BebZomrqCy6tjbQk8">
