        ...
        <div class="w-full px-8 md:w-3/4 md:px-0 mx-auto relative overflow-x-hidden md:overflow-x-visible">
                    ...
                    <div class="px-3 mt-5">
                        ...
                        <a href="detail-artikel.html">
                            <div class="flex items-center group gap-2 mt-5">
                                <p class="text-[#E8A26A] group-hover:text-[#EACDB5] text-lg font-semibold"
                                    style="font-family: 'Onest';">Lihat Artikel
                                </p>
                                <svg width="21" height="10" viewBox="0 0 21 10" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M16.2178 1L20.0005 4.75M20.0005 4.75L16.2178 8.5M20.0005 4.75H1.84375"
                                        class="stroke-[#E8A26A] group-hover:stroke-[#EACDB5]" stroke-width="2"
            ...
            <div class="flex items-center gap-4 mt-10">
                ...
                <div class="w-10 h-10 bg-[#7BA5B0] rounded-full items-center justify-center flex aspect-square">
                    <p class="text-white text-lg font-medium" style="font-family: 'Fredoka';">1</p>
                </div>
                <div
                    class="w-10 h-10 outline-2 outline-[#7BA5B0] outline-offset-[-2px] rounded-full items-center justify-center flex aspect-square">
                    <p class="text-[#7BA5B0] text-lg font-medium" style="font-family: 'Fredoka';">2</p>
                </div>
                <div
                    class="w-10 h-10 outline-2 outline-[#7BA5B0] outline-offset-[-2px] rounded-full items-center justify-center flex aspect-square">
                    <p class="text-[#7BA5B0] text-lg font-medium" style="font-family: 'Fredoka';">3</p>
                </div>
                <div
                    class="w-10 h-10 outline-2 outline-[#7BA5B0] outline-offset-[-2px] rounded-full items-center justify-center flex aspect-square">
                    <p class="text-[#7BA5B0] text-lg font-medium" style="font-family: 'Fredoka';">4</p>
                </div>
            </div>
        </div>
