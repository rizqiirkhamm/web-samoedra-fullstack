...
<body>
    ...
    <div class="flex justify-center flex-col items-center ">
        <h1 class="text-[#3E5467] mt-16 font-semibold text-4xl xl:text-5xl text-center z-50" style="font-family: 'Fredoka';">
            Halo👋🏻, Selamat Datang <br> Di Daycare Rumah Samoedra
                </h1>
        <div class="flex gap-5 mt-10 z-50">
                    <a href="{{route('welcome')}}">
                <button class="bg-[#3E5467] rounded-full flex items-center gap-2 text-white px-6 py-2 transition-all duration-300 hover:bg-[#BDBDCB]">
                    Daftar
        ...
        <div class="w-full px-8 md:w-3/4 md:px-0 mx-auto md:py-10 relative z-10">
                        ...
                        <div class="w-full xl:w-9/12">
                            @if($daycareData['banner_type'] == 'video')
                                <div class="rounded-3xl overflow-hidden h-96">
                                    <iframe width="100%" height="100%" src="{{ str_replace('watch?v=', 'embed/', $daycareData['banner_video']) }}"
                                        frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                        allowfullscreen class="w-full h-full object-cover"></iframe>
                                </div>
                            @else
                        <img src="{{asset($daycareData['banner_image'])}}" alt="Samoedra Daycare"
                                class="rounded-3xl h-96 w-full object-cover">
                            @endif
                            <!-- Kelebihan Daycare -->
                    <h1 class="font-semibold text-[#3E5467] text-3xl xl:text-4xl mt-8" style="font-family: 'Fredoka';">
                        Apa itu Daycare Rumah Samoedra?
                    </h1>
                            <p class="text-[#A2A2BD] mt-4" style="font-family: 'Onest';">
                                {{ $daycareData['kelebihan_daycare'] }}
                            </p>
                        </div>
                        <div class="w-full xl:w-1/3">
                            <!-- Kartu Informasi -->
                            <div class="bg-[#F3EEE6] p-8 rounded-3xl">
                        <h2 class="font-semibold text-[#3E5467] text-2xl md:text-3xl mb-5" style="font-family: 'Fredoka';">
                            About Daycare
                        </h2>
                                <div class="space-y-3">
                            ...
                            <div class="flex justify-between border-b-2 border-dashed pb-3 border-[#E8A26A] items-center">
                                ...
                                <p class="text-[#A2A2BD] text-end max-w-72" style="font-family: 'Onest';">
                                    {{ $daycareData['about_daycare']['details']['jam_operasional'] }}
                                </p>
                                    </div>
                            <div class="flex justify-between border-b-2 border-dashed pb-3 border-[#E8A26A] items-center">
                                        <flex class="flex-row flex items-center space-x-3">
                                ...
                                <p class="text-[#A2A2BD] text-end max-w-72" style="font-family: 'Onest';">
                                    {{ $daycareData['about_daycare']['details']['hari'] }}
                                </p>
                            </div>
                                    </div>
                                </div>
                    <!-- Caregiver Information -->
                    <div class="bg-[#F3EEE6] p-8 rounded-3xl mt-5">
                        <h2 class="font-semibold text-[#3E5467] text-2xl md:text-3xl mb-5" style="font-family: 'Fredoka';">
                            About Care Giver
                        </h2>
                                <div class="space-y-3">
                            @foreach($daycareData['about_caregiver']['caregivers'] as $caregiver)
                                <div class="flex justify-between border-b-2 border-dashed pb-3 border-[#E8A26A] items-center">
                                        <flex class="flex-row flex items-center space-x-3">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M12.1012 0.664006C12.7292 0.248006 13.7932 -0.0489938 14.5962 0.754006L19.2432 5.40201C20.0492 6.20601 19.7512 7.27001 19.3342 7.89701C19.1084 8.23699 18.8145 8.52642 18.4712 8.74701C18.1372 8.96001 17.7152 9.12101 17.2602 9.09701C17.04 9.08141 16.8206 9.05773 16.6022 9.02601L16.5342 9.01601C16.2996 8.98237 16.0637 8.95802 15.8272 8.94301C15.3232 8.91801 15.1292 9.00301 15.0672 9.06301L12.5772 11.554C12.4972 11.634 12.3972 11.812 12.3212 12.154C12.2482 12.484 12.2162 12.89 12.2082 13.34C12.2012 13.772 12.2162 14.214 12.2322 14.64L12.2332 14.687C12.2482 15.11 12.2632 15.542 12.2422 15.881C12.1772 16.912 11.3742 17.671 10.5842 18.022C9.79418 18.372 8.66718 18.459 7.88418 17.675L5.63418 15.425L1.52918 19.53C1.46051 19.6037 1.37771 19.6628 1.28572 19.7038C1.19372 19.7448 1.0944 19.7668 0.9937 19.7686C0.892997 19.7704 0.792968 19.7518 0.69958 19.7141C0.606191 19.6764 0.521357 19.6203 0.450139 19.549C0.37892 19.4778 0.322775 19.393 0.285054 19.2996C0.247333 19.2062 0.228809 19.1062 0.230585 19.0055C0.232362 18.9048 0.254404 18.8055 0.295396 18.7135C0.336388 18.6215 0.39549 18.5387 0.469177 18.47L4.57318 14.365L2.32318 12.115C1.54018 11.331 1.62618 10.205 1.97718 9.41501C2.32718 8.62501 3.08718 7.82201 4.11718 7.75701C4.45718 7.73601 4.88918 7.75101 5.31218 7.76601L5.35918 7.76701C5.78518 7.78201 6.22718 7.79801 6.65918 7.79101C7.10918 7.78301 7.51518 7.75101 7.84518 7.67801C8.18718 7.60201 8.36518 7.50101 8.44518 7.42101L10.9352 4.93101C10.9962 4.87001 11.0812 4.67501 11.0552 4.17101C11.0402 3.93447 11.0158 3.69862 10.9822 3.46401L10.9732 3.39601C10.9415 3.17762 10.9178 2.95814 10.9022 2.73801C10.8772 2.28301 11.0382 1.86101 11.2502 1.52701C11.4662 1.18701 11.7652 0.887006 12.1012 0.664006Z" fill="#E8A26A"/>
            ...
            <div class="w-full  px-8 md:w-3/4 md:px-0 mx-auto flex flex-col pb-16 md:flex-row mt-24">
                        <div class="w-full lg:w-1/2 flex flex-col justify-center">
                            <div class="space-y-3">
                        <p class="text-[#E8A26A] text-xl" style="font-family: Fuzzy Bubbles;">Program Daycare</p>
                                <h1 class="text-[#3E5467] font-semibold text-4xl xl:text-5xl text-start"
                            style="font-family: 'Fredoka';">Program Daycare Rumah Samoedra</h1>
                        <p class="text-[#A2A2BD] max-w-xl mt-5" style="font-family: 'Onest';">Layanan penitipan anak berkualitas dengan pendekatan pendidikan yang holistik dan fokus pada perkembangan anak</p>
                            </div>
                        ...
                        <div class="w-full lg:w-1/2 relative flex justify-center items-center">
                            ...
                            <img src="{{ asset($daycareData['program']['image'] ?? 'images/assets/img_layanan.png') }}" class="w-full h-full object-cover object-center" alt="Program Daycare">
                                </div>
                            </div>
                ...
                <div class="w-full relative flex flex-col justify-center items-center py-28">
                    ...
                    <div
                        ...
                        <div class="flex flex-row gap-7 py-10 overflow-x-auto">
                            ...
                            @foreach($daycareData['facilities'] as $facility)
                            <!-- Card Template -->
                            <div class="w-80 h-64 rounded-4xl bg-white p-6 flex flex-col relative">
                            <img src="{{ asset($facility['image'] ?? 'images/assets/img_layanan.png') }}" alt="{{ $facility['title'] ?? 'Fasilitas Daycare' }}"
                                    class="w-full h-44 rounded-3xl object-cover">
                                <h1 class="text-3xl text-[#3E5467] font-semibold text-center mt-3"
                                    style="font-family: 'Fredoka';">{{ $facility['title'] ?? 'Fasilitas' }}</h1>
                            </div>
                            @endforeach
            ...
            <div class="w-full md:w-3/4 mx-auto px-8 md:px-0">
                ...
                <div class="mt-10 overflow-x-auto">
                    <table class="w-full border-collapse border border-[#E8A26A] min-w-[800px]">
                        ...
                        <tbody>
                            @foreach($daycareData['pricelist'] as $index => $price)
                            <tr>
                                ...
                                <td class="border border-[#E8A26A] px-4 py-3 text-[#3E5467] text-center"
                                    style="font-family: 'Onest';">{{ $price['title'] }}</td>
                                <td class="border border-[#E8A26A] px-4 py-3 text-[#3E5467] text-center"
                                    style="font-family: 'Onest';">{{ $daycareData['about_daycare']['details']['usia'] ?? '6 bln s/d 12 thn' }}</td>
                                <td class="border border-[#E8A26A] px-4 py-3 text-[#3E5467] text-center"
                                style="font-family: 'Onest';">{{ $price['description'] ?? '-' }}</td>
                                <td class="border border-[#E8A26A] px-4 py-3 text-[#3E5467] text-center"
                                    style="font-family: 'Onest';">{{ $price['price'] }}</td>
                                <td class="border border-[#E8A26A] px-4 py-3 text-[#3E5467] text-center"
                                style="font-family: 'Onest';">{{ $price['food_cost'] ?? '12.5k / Porsi, 5k Snack' }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="border border-[#E8A26A] px-4 py-3 text-[#3E5467] text-center"
                                    style="font-family: 'Onest';">{{ str_pad($index + 1, 2, '0', STR_PAD_LEFT) }}</td>
                                <td class="border border-[#E8A26A] px-4 py-3 text-[#3E5467] text-center"
                                    style="font-family: 'Onest';">{{ $activity['time'] }}</td>
                                <td class="border border-[#E8A26A] px-4 py-3 text-[#3E5467] text-center"
                                    style="font-family: 'Onest';">{{ $activity['title'] }}</td>
                                <td class="border border-[#E8A26A] px-4 py-3 text-[#3E5467] text-center"
                                    style="font-family: 'Onest';">{{ $activity['description'] }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
        ...
        <section id="galery">
            <div class="w-full px-8 md:w-3/4 md:px-0 mx-auto">
                ...
                $categories = $galleries->pluck('category')->unique()->implode(', ');
                @endphp
                <div class="text-sm text-gray-500 mb-4" style="display: none;">
                    Debug: {{ $galleryCount }} galleries found. Categories: {{ $categories }}
                </div>
            ...
            <div class="flex justify-center mb-16">
                <a href="{{ route('program') }}" class="bg-[#3E5467] rounded-full flex items-center gap-2 text-white px-6 py-3 transition-all duration-300 hover:bg-[#576B81]">
